    ...
    <div className='flex flex-col gap-4 my-10 mx-5 md:mx-30'>
      <section id='advertiser' className='flex flex-col md:flex-row justify-center gap-10'>
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-5'>
            <h2 className='text-primary max-md:self-center text-3xl font-medium'>
                Advertiser
            </h2>
            ...
            <a className='text-primary text-base hover:text-blue-400 transition-all duration-75 max-md:self-center' href='#contact'>
                Join Us
            </a>
        </div>
