        ...
        <div className="space-y-8">
          <section className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <br />
              <strong className="text-secondary">Ad Creatives:</strong> Banners, videos, text links, and other marketing materials.
              <br />
              <strong className="text-secondary">Ad Space:</strong> The platform or media used by the Publisher for promotions.
            </p>
          </section>
          ...
          <section className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <ul className="list-disc pl-6 text-lg text-gray-700 space-y-2">
              <li className="py-1">The Publisher must provide accurate, up-to-date information at all times.</li>
              <li className="py-1">The Publisher is responsible for account security and must not share credentials.</li>
              ...
              <li className="py-1">Publishers are responsible for ensuring compliance with local laws.</li>
              <li className="py-1">Guest accounts may be created under the main account, with full accountability remaining with the Publisher.</li>
            </ul>
          </section>
          ...
          <section className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <ul className="list-disc pl-6 text-lg text-gray-700 space-y-2">
              <li className="py-1">Simulating or fabricating Deals using false or unauthorized data.</li>
              <li className="py-1">Using deceptive or coercive marketing tactics.</li>
              <li className="py-1">Unauthorized use of Advertiser or third-party intellectual property.</li>
              <li className="py-1">Bidding on third-party brand terms without prior approval.</li>
              <li className="py-1">Employing cookie stuffing, cloaking, or related techniques.</li>
          ...
          <section className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <ul className="list-disc pl-6 text-lg text-gray-700 space-y-2">
              <li className="py-1">Payment is contingent on valid, tracked, and authorized Deals.</li>
              <li className="py-1">Publishers must review and accept applicable rates before promotion begins.</li>
              <li className="py-1">Payments are processed within 45 business days of a valid withdrawal request and confirmation.</li>
